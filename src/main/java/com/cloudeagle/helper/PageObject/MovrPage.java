...
public class MovrPage extends PageBase {
	...
	By thankYOYTextAfterPaymentOfPkg = By.xpath("//H1[@class='display-3'][text()='Thank you!']");
	...
	public void clickUserAfterPayment() throws InterruptedException {

		//wHelper.waitForVisibilityLoader();
		
	
		
		wHelper.waitForPresenceOfElement(thankYOYTextAfterPaymentOfPkg);
		
		System.out.println(" Inside Click Usr");

		userss = wHelper.handleStaleElement(userssBy, 5, 20);
		wHelper.waitForElementToBeClickableAndClick(userss);
	...
	public void ClickMOVR() throws InterruptedException {
		...
		wHelper.waitForElementToBeClickableAndClick(movr);
	...
	public void validateData(String Name, String LastName, String MobileNumber, String PostalCode)
		...
		softAssert1.assertEquals(wHelper.handleStaleElement(mobileNumberBY, 5, 20).getAttribute("value"),MobileNumber);
...
//		wHelper.waitForVisibility(trainerName);
	...
	By scheduleBookingBttnBY =By.xpath("//A[@id='btnScheduleBooking']");
	...
	By trainerSlotBY = By.xpath("//a[@class='right-arrow calendar-custom-arrow']/following::div[position()=1]//h6");
	...
	By trainerSlotNextWeekBY = By.xpath("//a[@class='right-arrow calendar-custom-arrow']");
	...
	By trainerSlotConfirmBttnBY = By.xpath("//button[@id='addsession-available-session-slot-confirm-btn']");
	...
	By reviewBttnBY = By.xpath("//a[normalize-space()='review']");
	...
	By sessionExpandBY = By.xpath("//button[@class ='btn btn-link collapsed']");
	...
	By waiverBttnBY = By.xpath("	//a[normalize-space()='Waiver']");
	...
	By paymentNowBttnBY = By.xpath("//a[normalize-space()='payment now']");
...
//		wHelper.waitForVisibility(variableToggleBttn);
	...
	public void clickScheduleBookingBttn() throws InterruptedException {
		...
		scheduleBookingBttn =	wHelper.handleStaleElement(scheduleBookingBttnBY, 5, 20);
		
		wHelper.waitForElementToBeClickableAndClick(scheduleBookingBttn);
	...
	public void clickSelectTrainerField() throws InterruptedException {
		...
		wHelper.waitForElementToBeClickableAndClick(selectTrainerField);
	...
	public void clickNextWeekArrowForTrainerSlot() throws InterruptedException {
		...
		trainerSlotNextWeek =	wHelper.handleStaleElement(trainerSlotNextWeekBY, 5, 20);
//		wHelper.waitForElementToBeClickable(trainerSlotNextWeek);
//		trainerSlotNextWeek.click();
		wHelper.waitForElementToBeClickableAndClick(trainerSlotNextWeek);
	...
	public void clickTrainerSlot() throws InterruptedException {
		...
		trainerSlot =	wHelper.handleStaleElement(trainerSlotBY, 5, 20);
		//wHelper.waitForElementToBeClickable(trainerSlot);dsds
		
		wHelper.waitForElementToBeClickableAndClick(trainerSlot);
		//trainerSlot.click();
	...
	public void clickTrainerSlotConfirmBttn() throws InterruptedException {
		...
		trainerSlotConfirmBttn =	wHelper.handleStaleElement(trainerSlotConfirmBttnBY, 5, 20);
	...
	public void clickReviewBttn() throws InterruptedException {
		...
		reviewBttn =wHelper.handleStaleElement(reviewBttnBY, 5, 20);
	...
	public void clickSessionExpand() throws InterruptedException {
		...
		sessionExpand =	wHelper.handleStaleElement(sessionExpandBY, 5, 20);
	...
	public void clickWaiverBttn() throws InterruptedException {
		...
		waiverBttn =	wHelper.handleStaleElement(waiverBttnBY, 5, 20);
	...
	//	 wHelper.waitForVisibilityLoader();
		...
		paymentNowBttn =	wHelper.handleStaleElement(paymentNowBttnBY, 5, 20);
	
		wHelper.waitForElementToBeClickableAndClick(paymentNowBttn);
